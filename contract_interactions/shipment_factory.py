...
shipment_factory_address = web3.to_checksum_address(os.getenv('SHIPMENT_FACTORY_ADDRESS'))
contract_abi = [
    {
        "constant": True,
        "inputs": [],
...
# Initialize contract
contract = web3.eth.contract(address=shipment_factory_address, abi=contract_abi)
